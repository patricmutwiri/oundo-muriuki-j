				...
				<tr class="<?php echo ($i % 2) ? 'odd' : 'even'; ?>" itemscope itemtype="https://schema.org/Person">
					...
					<?php if ($this->params->get('show_position_headings')) : ?>
						<td class="item-position" itemprop="jobTitle">
							<?php if($item->image) { ?>
							<a title="<?php echo $item->address ?>" href="<?php echo JRoute::_(ContactHelperRoute::getContactRoute($item->slug, $item->catid)); ?>" itemprop="url">
								<img src="<?php echo $item->image ?>" class="img-responsive con-image" />
							</a>
							<?php } ?>
